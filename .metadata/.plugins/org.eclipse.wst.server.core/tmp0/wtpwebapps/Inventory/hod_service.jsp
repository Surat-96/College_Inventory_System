...
<html lang="zxx">
 ...
 <!-- short -->
	...
	<% list=(ArrayList<servicemodel>)request.getAttribute("info2");%>
      
      
      <!-- Start tables -->
				 <div class="sub-title">
                     <div class="sub-head mb-3 ">
                        <h4>HOD_Service_List</h4>
                     </div>
                     ...
                     <table class="table" id="table">
						...
						<tbody class="border border-primary">
							<%
            				for(servicemodel srmod : list)
            				{
          					%>
							<tr>
							<td class="border border-info"><%=srmod.getSerid() %></td>
							<td class="border border-info"><%=srmod.getName() %></td>
							<td class="border border-info"><%=srmod.getType() %></td>
							<td class="border border-info"><%=srmod.getTime() %></td>
							<td class="border border-info"><%=srmod.getMsg() %></td>
							<% 
                     		String stat= srmod.getStatus();
                     		int s = Integer.parseInt(stat); 
                     		if(s == 1){ 
                     		%>
                     		<td class="border border-info">
                     		<form action="hodaprov1?serid=<%=srmod.getSerid()%>" method="post"><button type="submit" class="btn btn-primary btn-block">Approval</button></form></br>
                     		<form action="hodnoaprov1?serid=<%=srmod.getSerid()%>" method="post"><button type="submit" class="btn btn-primary btn-block">NotApproval</button></form>
                     		</td>
                     		<%} %>
                     		</tr>
						<%} %>					  
