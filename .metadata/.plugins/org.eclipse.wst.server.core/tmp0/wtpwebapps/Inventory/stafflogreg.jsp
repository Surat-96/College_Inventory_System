 	     ...
 	     function ajaxFunction() 
 	     {
	    	...
	    	alert(email);
 			 ...
 			 if(xmlhttp.readyState == 0 || xmlhttp.readyState == 4 )        
 	         {
 	    		 var email = document.getElementById("email1").value;
 	    		//alert(email);
 	    		xmlhttp.open("GET","checkusername?email="+email, true);
 	    ...
 	    function handleServerResponse() 
 	     {
 	        ...
 	        if (xmlhttp.readyState == 4) 
 	        {
 	            if(xmlhttp.status == 200) 
 	            {
 	            	...
 	            	var found = xmlMessage.getElementsByTagName("found")[0].firstChild.nodeValue;
 	            	
 	            	if(found == "true")
 	            	{
 	            		var validationMessage=document.getElementById("validationMessage");
 	            		validationMessage.innerHTML = "EMAIL Id PRESENT..TRY OTHER EMAILID";
 	            	...
 	            	{
 	            		var validationMessage=document.getElementById("validationMessage");
 	            		validationMessage.innerHTML = "EMAIL Id AVALABLE";
				...
				<% if(request.getAttribute("Message") != null) { %>
					...
					<div id="horizontalTab" style="display: block; width: 100%; margin: 0px;">
						<ul class="resp-tabs-list">
							<li class="resp-tab-item" aria-controls="tab_item-0" role="tab"><span>Staff Sign in</span></li> 
							<li class="resp-tab-item" aria-controls="tab_item-1" role="tab"><label>/</label><span>Staff Sign up</span></li>
						</ul>	
					<div class="clear"> </div>
						...
						<div class="tab-1 resp-tab-content" aria-labelledby="tab_item-0">
							<div class="login-agileits-top"> 
								<form action="stafflogin" method="post">
									<p>Email-ID </p>
									<input type="email" name = "emailid" id="emailid" required="" autofocus=""/>
									<p>Password</p>
									<input type="password" name = "password" id="password" maxlength="20" required="" autofocus=""/>
									<input type="checkbox" id="brand" onclick="showpassword()">
									<label for="brand"><span></span>show password</label>
									<p>Designation</p>
									<select name = "desi" id = "desi">    
        							<option value="teachers">TEACHERS</option>
        							<option value="labassit">LAB-ASSITANT</option>
        							</select>
							...
							<div class="login-agileits-bottom"> 
								<h2><a href="frgtpass.jsp">Forgot password?</a></h2>
							</div> 
						</div> 
						<div class="tab-1 resp-tab-content" aria-labelledby="tab_item-1">
							<div class="login-agileits-top sign-up"> 
								<form action="staffregistration" method="post">
									<p>Staff Name </p>
									<input type="text" name="staffname" id="staffname" maxlength="20" required="" autofocus="" />
									<!--  <p id="validationMessage" style="color: red; font-weight: bold;"></p>-->
									<p>Email-ID </p>
									<input type="email" name = "email" id="email1" required="" autofocus="" autocomplete="off" onblur="ajaxFunction()"/>
									<p>Password</p>
									<input type="password" name = "password" id="password1" maxlength="20" required="" autofocus=""/>
									<input type="checkbox" id="brand2" onclick="showpassword1()">
									<label for="brand2"><span></span>show password</label> 	
									<p>Address</p>
									<input type="text" name = "address" id = "address" maxlength = "50" required="" autofocus="">
									<p>Date of Joining</p>
									<input type="date" name = "doj" id="doj" required="required" autofocus="autofocus">
									<p>Mobile-No</p>
									<input type="number" name = "mob" id = "mob" maxlength="10" required="required" autofocus="autofocus">
									<p>Department</p>
									...
									<label for="brand3"><span></span>I accept the terms use</label> 
