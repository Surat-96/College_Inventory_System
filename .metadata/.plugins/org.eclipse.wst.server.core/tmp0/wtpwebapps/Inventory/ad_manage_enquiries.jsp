...
<%@page import="com.inventory.model.enqrymodel" %>
   ...
   <div class="page-container">
		<!--start content-inner-->
			...
			<div class="mother-grid-inner">
					...
					<ol class="breadcrumb">
					<li class="breadcrumb-item"><a href="ad_index.jsp">Home</a> <i class="fa fa-angle-right"></i>Manage Feedback</li>
					</ol>
            	
            	<%! ArrayList<enqrymodel> list = null; %>
				<% list=(ArrayList<enqrymodel>)request.getAttribute("info");%>
						...
						<div class="w3l-table-info">
							...
							<table id="table" class="table-bordered border-success">
								...
								<tbody>
									...
									<td><%=emod.getName() %></td>
									<td><%=emod.getEmail() %></td>
									<td><%=emod.getDepartment() %></td>
									<td><%=emod.getDesignation() %></td>
									<td><%=emod.getTime() %></td>
									<td><%=emod.getMsg() %></td>
									<td>
									<form action="delfdbc?id=<%=emod.getId()%>" method="post"><button type="submit" class="btn btn-primary btn-block">Delete</button></form>
									</td>
									</tr>	
									<%}%>					  
								</tbody>
