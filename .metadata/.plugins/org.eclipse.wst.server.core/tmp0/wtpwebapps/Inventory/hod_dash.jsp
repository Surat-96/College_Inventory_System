 ...
 <!-- short -->
      <div class="using-border py-3">
         <div class="inner_breadcrumb  ml-4">
            <ul class="short_ls">
               <li>HOD_Profile</li>
               <!--  <li id="flip">ADDMIN REGISTRATION</li>-->
            </ul>
         </div>
      </div>
      <!-- //short-->
      ...
      <%! ArrayList<staffmodel> list = null; %>
      
	  <% HttpSession ses = request.getSession();
	  list=(ArrayList<staffmodel>)ses.getAttribute("info1");
	  %>
			...
			<div class="inset agile">
				...
				<div id="horizontalTab" style="display: block; width: 100%; margin: 0px;">
						<ul class="resp-tabs-list">
							<li class="resp-tab-item" aria-controls="tab_item-0" role="tab"><span>HOD_DASHBOARD</span></li> 
						</ul>	
					<div class="clear"> </div>
					<div class="alert-close"> </div> 
					<div class="resp-tabs-container">
					<div class="tab-1 resp-tab-content1" aria-labelledby="tab_item-1">
							<div class="login-agileits-top sign-up"> 
									<%
            					for(staffmodel smod : list)
            					{
          						%> 
									<p>HOD Name </p>
									<input type="text" name="staffname" id="staffname" value="<%=smod.getStaffname() %>" />
									<p>Email-ID </p>
									<input type="email" name="email" id="email" value="<%=smod.getEmailid() %>" />
									<p>Password</p>
									<input type="password" name="password" id="password1" value="<%=smod.getPassword() %>"/>
									<input type="checkbox" id="brand2" onclick="showpassword1()">
									<label for="brand2"><span></span>show password</label> 	
									<p>Address</p>
									<input type="text" name="address" id = "address" value="<%=smod.getAddress() %>" />
									<p>Date of Joining</p>
									<input type="text" name="doj" id="doj" value="<%=smod.getJoiningDate() %>" />
									<p>Mobile-No</p>
									<input type="text" name="mob" id = "mob" value="<%=smod.getMobileno() %>" />
									<p>Department</p> 
									<input type="text" name="dept" id = "dept" value="<%=smod.getDepartment() %>" />
									<p>Designation</p>  
									<input type="text" name="desi" id = "desi" value="<%=smod.getDesignation() %>" />
								<%} %> 	
									<form action = "stafflogout" method = "post"><input type="submit" value="LOGOUT" id = "logout"></form>
									<a href="hod_update.jsp"><input type="submit" value="UPDATE" id = "update"></a> 
							</div>
						</div>
					</div>							
				</div>	 
