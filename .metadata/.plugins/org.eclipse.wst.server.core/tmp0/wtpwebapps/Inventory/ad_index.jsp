   ...
   <div class="page-container">
		<!--start content-inner-->
			...
			<div class="mother-grid-inner">
				...
				<ol class="breadcrumb">
					<li class="breadcrumb-item"><a href="ad_index.jsp">Home</a> <i class="fa fa-angle-right"></i></li>
				</ol>
				<!--four-grids here-->
				...
				<% if(request.getAttribute("Message") != null) { %>
					...
					<div class="col-md-3 four-grid">
						<div class="four-agileits">
							...
							<div class="four-text">
								<form action="staffshw" method="post"><button type="submit" class="btn btn-succss fa fa-edit">MANAGE STAFFS</button></form>
							</div>
						</div>
					</div>
					<div class="col-md-3 four-grid">
						<div class="four-agileinfo">
							...
							<div class="four-text">
								<form action="adpromang" method="post"><button type="submit" class="btn btn-succss fa fa-edit">MANAGE PRODUCT </button></form>
							</div>				
						</div>
					</div>
					<div class="col-md-3 four-grid">
						<div class="four-agileinfo">
							...
							<div class="four-text">
								<form action="adsermang" method="post"><button type="submit" class="btn btn-succss fa fa-edit">MANAGE SERVICE</button></form>
							</div>
						</div>
					</div>
					<div class="col-md-3 four-grid">
						<div class="four-wthree">
							...
							<div class="four-text">
								<a href="ad_manage_stocks_pre.jsp">MANAGE STOCKS</a>					
							</div>							
						</div>
					</div>
					<div class="clearfix"></div>
				...
				<div class="four-grids">
					<div class="col-md-3 four-grid">
						<div class="four-w3ls">
							...
							<div class="four-text">
								<form action="enqryshw" method="post"><button type="submit" class="btn btn-succss fa fa-edit">MANAGE Feedback</button></form>
							</div>							
						</div>
					</div>
					<div class="clearfix"></div>
