          	...
          	%>
               <div class="col-lg-4 col-md-6 col-sm-6 gallery-grids">
                  <figure class="effect-goliath">
                     <img src="images/<%=smod.getImage()%>" width="300" height="400" alt=""/>
                     <figcaption>
                        <h6><%=smod.getItemname() %></h6>
                        <form action="detstck?itemname=<%=smod.getItemname()%>" method="post" class="gallery-box" data-lightbox="example-set" data-title="">
                        <button type="submit" class="btn btn-primary btn-block">Details</button></form>
                     </figcaption>
                  </figure>
               </div>
               <%}%>
