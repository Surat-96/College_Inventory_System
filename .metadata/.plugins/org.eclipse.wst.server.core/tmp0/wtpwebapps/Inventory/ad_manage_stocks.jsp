   ...
   <div class="page-container">
		<!--start content-inner-->
			...
			<div class="mother-grid-inner">
					...
					<ol class="breadcrumb">
					<li class="breadcrumb-item"><a href="ad_index.jsp">Home</a> <i class="fa fa-angle-right"></i>Manage Stocks</li>
					</ol>
						...
						<div class="w3l-table-info">
							...
							<table id="table">
								...
								<%
									...
									<tr>
									<td><%=smod.getId() %></td>
									<td><%=smod.getItemname() %></td>
									<td><%=smod.getType() %></td>
									<td><%=smod.getCost() %></td>
									<td><img src="images/<%=smod.getImage() %>" width="100" height="100"></td>
									<td>
										<form action="stkdet?id=<%=smod.getId()%>" method="post"><button type="submit" class="btn btn-primary btn-block">Details</button></form>
									</td>
									</tr>
									<%}%>
								</tbody>
