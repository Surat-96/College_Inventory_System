 ...
 <!-- short -->
	  ...
	  %>
            <div class="title text-center mb-lg-5 mb-md-4 mb-sm-4 mb-3">
               <h3>Show-Staff-List</h3>
            </div>
            <div class="agile-info-para">
               <!--contact-map -->
               <form action = "displayallstaff" method = "post"> 
               <% for(staffmodel smod : list) { %> 
                  <div class="row agile-wls-contact-mid">
                     <div class="col-md-4 form-group contact-forms">
                        <input type="text" name="depart" id="department" class="form-control" value="<%=smod.getDepartment() %>">
                     </div>
                     <div class="col-md-4 form-group contact-forms">
                     ...
                     <div class="col-md-4 form-group contact-forms">
                        <button type="submit" class="btn btn-success">Staff_List</button>
                     </div>
                  </div>
                  <%} %>
               </form>
