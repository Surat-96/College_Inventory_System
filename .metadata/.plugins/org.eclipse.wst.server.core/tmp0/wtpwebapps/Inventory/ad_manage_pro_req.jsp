   ...
   <div class="page-container">
		<!--start content-inner-->
			...
			<div class="mother-grid-inner">
					...
					<ol class="breadcrumb">
					<li class="breadcrumb-item"><a href="ad_index.jsp">Home</a> <i class="fa fa-angle-right"></i>Manage Product Request</li>
					</ol>
						...
						<div class="w3l-table-info">
							...
							<table id="table" class="table-bordered border-success">
								...
								<tbody class="border border-primary">
									...
									<tr>
									<td><%=aps.getReqid() %></td>
									<td><%=aps.getStaffname() %></td>
									<td><%=aps.getItemname() %></td>
									<td><%=aps.getDate() %></td>
									<td>
									<form action="addetprom?reqid=<%=aps.getReqid()%>" method="post"><button type="submit" class="btn btn-primary btn-block">Details</button></form></br>
									</td>
									</tr>
									<%} %>					  
								</tbody>
