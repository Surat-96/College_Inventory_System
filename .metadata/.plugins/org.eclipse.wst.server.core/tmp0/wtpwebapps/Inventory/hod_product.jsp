...
<html lang="zxx">
   <head>
      ...
      <!-- tables Manage-->
		<link href="CSS2/buttons.bootstrap4.min.css" rel='stylesheet' />
		<link href="CSS2/jquery.dataTables.min.css" rel='stylesheet'/>

		<script src="JS2/jQuery-1.12.4.js"></script>
		<script src="JS2/jquery.dataTables.min.js"></script>
		<script src="JS2/dataTables.buttons.min.js"></script>
		<script src="JS2/buttons.flash.min.js"></script>
		<script src="AJAX2/jszip.min.js"></script>
		<script src="AJAX2/pdfmake.min.js"></script>
		<script src="AJAX2/vfs_fonts.js"></script>
         ...
         <div class="header-most-top">
            ...
            <div class="headder-nav-icon pagescrollfix">
               ...
               <nav class="navbar navbar-expand-lg navbar-light pagescrollfix">
                        <div class="hedder-up">
                           <h1><a class="navbar-brand " href="hod_dash.jsp"><span class="fa fa-envira"></span>ANODITE CELL</a></h1>
                        </div>
                        ...
                        <div class="collapse navbar-collapse justify-content-end" id="navbarSupportedContent">
                           <ul class="navbar-nav ">
                              <li class="nav-item active">
                                 <a class="nav-link" href="hod_dash.jsp">HOD_Profile<span class="sr-only">(current)</span></a>
                              </li>
                              <li class="nav-item">
                                 <a href="staff_list_pre.jsp" class="nav-link">Staff_List</a>
                              </li>
                              <li class="nav-item dropdown">
                                 <a href="hod_cart_pre.jsp" class="nav-link">Manage</a>
                             </li>
                              <li class="nav-item">
                                 <a href="hod_feed.jsp" class="nav-link">Feedback</a>
                              </li>
                           </ul>
                        </div>
                     </nav>
 ...
 <!-- short -->
	...
	<% list=(ArrayList<applystock>)request.getAttribute("info2");%>
      
      <!-- Start tables -->
				 <div class="sub-title">
                     <div class="sub-head mb-3 ">
                        <h4>HOD_Product_List</h4>
                     </div>
                     ...
                     <table class="table" id="table">
						...
						<tbody class="border border-primary">
            				...
            				for(applystock aps : list)
            				{
          					%>
							<tr>
							<td class="border border-info"><%=aps.getReqid() %></td>
							<td class="border border-info"><%=aps.getStaffname() %></td>
							<td class="border border-info"><%=aps.getItemname() %></td>
							<td class="border border-info"><%=aps.getQuantity() %></td>
							<td class="border border-info"><%=aps.getReq_quant() %></td>
							<td class="border border-info"><%=aps.getDate() %></td>
                     		<% 
                     		String stat= aps.getStatus();
                     		int s = Integer.parseInt(stat); 
                     		if(s == 1){ 
                     		%>
                     		<td class="border border-info">
                     		<form action="hodaprov?reqid=<%=aps.getReqid()%>" method="post"><button type="submit" class="btn btn-primary btn-block">Approval</button></form></br>
                     		<form action="hodnoaprov?reqid=<%=aps.getReqid()%>" method="post"><button type="submit" class="btn btn-primary btn-block">NotApproval</button></form>
                     		</td>
                     		<%} %>
                     		</tr>
						<%} %>					  
      ...
      <div class="title text-center mb-lg-5 mb-md-4 mb-sm-4 mb-3">
               <button type="submit" class="btn btn-warning"><a href="hod_dash.jsp">Back</a></button>
            </div>
