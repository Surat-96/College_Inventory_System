 ...
 * Generated at: 2019-12-01 05:59:10 UTC
...
public final class ad_005fchange_005fpassword_jsp extends org.apache.jasper.runtime.HttpJspBase
 ...
 ArrayList<adminmodel> list = null; 
  ...
  static {
    ...
    _jspx_imports_classes.add("com.inventory.model.adminmodel");
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("\t\t\t\t\t \t\t{\r\n");
      out.write("\t\t\t\t\t \t\t    var x = document.getElementById(\"cpassword\");\r\n");
      ...
      out.write("\t\t\t\t\t<li class=\"breadcrumb-item\"><a href=\"ad_index.jsp\">Home</a> <i class=\"fa fa-angle-right\"></i>Update Password</li>\r\n");
      out.write("\t\t\t\t</ol>\r\n");
      out.write("\t\t\t\t\r\n");
      out.write("\t\t\t\t");
      out.write("\r\n");
 ...
 HttpSession ses1 = request.getSession();
      ...
      out.write("\t\t\t\t\t\t<h3>Update Password </h3>\r\n");
      out.write("\t\t\t\t\t\t<form action=\"adminupdt\" class=\"form-horizontal\" name=\"stock\" method=\"post\">\r\n");
      out.write("\t\t\t\t\t\t");
      ...
      out.write("\t\t\t\t\t\t\t<label class=\"col-md-2 control-label\">Admin Name</label>\r\n");
      out.write("\t\t\t\t\t\t\t<div class=\"col-md-8\">\r\n");
      out.write("\t\t\t\t\t\t\t\t<div class=\"input-group\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<span class=\"input-group-addon\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<i class=\"fa fa-circle-o\"></i>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t</span>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<input type=\"text\" name=\"adminname\" class=\"form-control1\" id=\"adminname\" value=\"");
      out.print( amod.getAdminname());
      out.write("\">\r\n");
      out.write("\t\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t<div class=\"form-group\">\r\n");
      out.write("\t\t\t\t\t\t\t<label class=\"col-md-2 control-label\">Current Password</label>\r\n");
      out.write("\t\t\t\t\t\t\t<div class=\"col-md-8\">\r\n");
      out.write("\t\t\t\t\t\t\t\t<div class=\"input-group\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<span class=\"input-group-addon\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<i class=\"fa fa-key\"></i>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t</span>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<input type=\"password\" name=\"cpassword\" class=\"form-control1\" id=\"cpassword\" value=\"");
      out.print( amod.getPassword() );
      out.write("\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<input type=\"checkbox\" id=\"brand2\" onclick=\"showpassword()\"><label for=\"brand2\">show password</label>\r\n");
      out.write("\t\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t<div class=\"form-group\">\r\n");
      out.write("\t\t\t\t\t\t\t<label class=\"col-md-2 control-label\">New Password</label>\r\n");
      out.write("\t\t\t\t\t\t\t<div class=\"col-md-8\">\r\n");
      out.write("\t\t\t\t\t\t\t\t<div class=\"input-group\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<span class=\"input-group-addon\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<i class=\"fa fa-key\"></i>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t</span>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<input type=\"password\" name=\"password\" class=\"form-control1\" id=\"password\" placeholder=\"New Password\" required=\"\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<input type=\"checkbox\" id=\"brand2\" onclick=\"showpassword1()\"><label for=\"brand2\">show password</label>\r\n");
      out.write("\t\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t</div>\r\n");
