 ...
 * Generated at: 2019-12-01 05:58:44 UTC
...
public final class ad_005fupdate_005fstocks_jsp extends org.apache.jasper.runtime.HttpJspBase
 ...
 ArrayList<stockmodel> list = null; 
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("\t\t\t\t\t<li class=\"breadcrumb-item\"><a href=\"ad_index.jsp\">Home</a> <i class=\"fa fa-angle-right\"></i>Update Stocks</li>\r\n");
      out.write("\t\t\t\t</ol>\r\n");
      out.write("\t\t\t\t\r\n");
      out.write("\t\t\t\t");
      out.write("\r\n");
 ...
 list=(ArrayList<stockmodel>)request.getAttribute("info1");
      ...
      out.write("\t\t\t\t\t<h3>Update Stocks</h3>\r\n");
      out.write("\t\t\t\t\t<div class=\"tab-content\">\r\n");
      out.write("\t\t\t\t\t\t<div class=\"tab-pane active\" id=\"horizontal-form\">\r\n");
      out.write("\t\t\t\t\t\t\t<form action=\"stkupdt\"class=\"form-horizontal\" name=\"stock\" method=\"post\">\r\n");
      out.write("\t\t\t\t\t\t\t\t");
      ...
      out.write("\t\t\t\t\t\t\t\t\t<label for=\"focusedinput\" class=\"col-sm-2 control-label\">Item Name</label>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<div class=\"col-sm-8\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<input type=\"text\" class=\"form-control1\" name=\"itemname\" id=\"itemname\"value=\"");
      out.print(smod.getItemname());
      out.write("\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t<div class=\"form-group\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<label for=\"focusedinput\" class=\"col-sm-2 control-label\">Item Type</label>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<div class=\"col-sm-8\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<input type=\"text\" class=\"form-control1\" name=\"type\" id=\"type\" value=\"");
      out.print(smod.getType());
      out.write("\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t<div class=\"form-group\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<label for=\"focusedinput\" class=\"col-sm-2 control-label\">Item Details</label>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<div class=\"col-sm-8\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<input type=\"text\" class=\"form-control1\" name=\"details\" id=\"details\" maxlength=\"500\" value=\"");
      out.print(smod.getDetails());
      out.write("\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t<div class=\"form-group\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<label for=\"focusedinput\" class=\"col-sm-2 control-label\">Item Purchase Date</label>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<div class=\"col-sm-8\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<input type=\"date\" class=\"form-control1\" name=\"pdate\" id=\"pdate\" value=\"");
      out.print(smod.getPurchasedate() );
      out.write("\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t<div class=\"form-group\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<label for=\"focusedinput\" class=\"col-sm-2 control-label\">Item Warrenty Date</label>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<div class=\"col-sm-8\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<input type=\"date\" class=\"form-control1\" name=\"warrenty\" id=\"warrenty\" value=\"");
      out.print(smod.getWarrenty() );
      out.write("\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t<div class=\"form-group\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<label for=\"focusedinput\" class=\"col-sm-2 control-label\">Item cost</label>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<div class=\"col-sm-8\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<input type=\"text\" class=\"form-control1\" name=\"cost\" id=\"cost\" value=\"");
      out.print(smod.getCost() );
      out.write("\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t<div class=\"form-group\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<label for=\"focusedinput\" class=\"col-sm-2 control-label\">Quantity</label>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<div class=\"col-sm-8\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<input type=\"text\" class=\"form-control1\" name=\"quant\" id=\"nquant\" value=\"");
      ...
      out.write("\t\t\t\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t\t\t\t<div class=\"form-group\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<label for=\"focusedinput\" class=\"col-sm-2 control-label\">Item Image</label>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<div class=\"col-sm-8\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<img src=\"images/");
      out.print(smod.getImage() );
      out.write("\" width=\"200\" height=\"200\"><!--<a href=\"ad_change_image.jsp\">Change Image</a>-->\r\n");
      out.write("\t\t\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t");
}
      ...
      out.write("\t\t\t\t\t\t\t\t\t\t<!--<button type=\"button\" class=\"btn btn-primary\">Delete</a>-->\r\n");
      out.write("\t\t\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t</form>\r\n");
      out.write("\t\t\t\t\t\t</div>\r\n");
