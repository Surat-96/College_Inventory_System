 ...
 * Generated at: 2019-12-01 05:58:38 UTC
...
public final class ad_005fmanage_005fstocks_jsp extends org.apache.jasper.runtime.HttpJspBase
 ...
 list=(ArrayList<stockmodel>)request.getAttribute("info");
      ...
      out.write("\t\t\t\t\t\t\t\t\t<td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<form action=\"stkdet?id=");
      out.print(smod.getId());
      out.write("\" method=\"post\"><button type=\"submit\" class=\"btn btn-primary btn-block\">Details</button></form>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t</td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t");
}
