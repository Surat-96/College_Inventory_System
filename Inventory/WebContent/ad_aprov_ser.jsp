   ...
   <div class="page-container">
		<!--start content-inner-->
			...
			<div class="mother-grid-inner">
				...
				<ol class="breadcrumb">
					<li class="breadcrumb-item"><a href="ad_index.jsp">Home</a> <i class="fa fa-angle-right"></i>Service Management</li>
				</ol>
				
				
				<%! ArrayList<servicemodel> list = null; %>
				<% list=(ArrayList<servicemodel>)request.getAttribute("info3");%>
				
				<div class="grid-form1">
					<h3>Service Management</h3>
					<div class="tab-content">
						<div class="tab-pane active" id="horizontal-form">
							<form action="admnseraprov"class="form-horizontal" name="stock" method="post">
								<%
            						for(servicemodel sermod : list)
            						{
          							%>
							
								<div class="form-group">
									<label for="focusedinput" class="col-sm-2 control-label">Service_Id</label>
									<div class="col-sm-8">
										<input type="text" class="form-control1" name="serid" id="serid"value="<%=sermod.getSerid()%>">
									</div>
								</div>
								<div class="form-group">
									<label for="focusedinput" class="col-sm-2 control-label">Staff_Name</label>
									<div class="col-sm-8">
										<input type="text" class="form-control1" name="staffname" id="staffname" value="<%=sermod.getName()%>">
									</div>
								</div>
								<div class="form-group">
									<label for="focusedinput" class="col-sm-2 control-label">Staff_Email</label>
									<div class="col-sm-8">
										<input type="eamil" class="form-control1" name="email" id="email" value="<%=sermod.getEmail()%>">
									</div>
								</div>
								<div class="form-group">
									<label for="focusedinput" class="col-sm-2 control-label">Service_Type</label>
									<div class="col-sm-8">
										<input type="text" class="form-control1" name="serty" id="serty" value="<%=sermod.getType() %>">
									</div>
								</div>
								<div class="form-group">
									<label for="focusedinput" class="col-sm-2 control-label">Submit_Date</label>
									<div class="col-sm-8">
										<input type="text" class="form-control1" name="date" id="date" value="<%=sermod.getTime() %>">
									</div>
								</div>
								<div class="form-group">
									<label for="focusedinput" class="col-sm-2 control-label">Service_Message</label>
									<div class="col-sm-8">
										<input type="text" class="form-control1" name="sermsg" id="sermsg" value="<%=sermod.getMsg() %>">
									</div>
								</div>
								<%}%>
								<div class="row">
