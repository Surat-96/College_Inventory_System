 ...
 <!-- short -->
	...
	<% list=(ArrayList<servicemodel>)request.getAttribute("info2");%>
                     ...
                     <table class="table" id="table">
						...
						<tbody class="border border-primary">
            				...
            				for(servicemodel srm : list)
            				{
          					%>
							<tr>
							<td class="border border-info"><%=srm.getName() %></td>
							<td class="border border-info"><%=srm.getEmail() %></td>
							<td class="border border-info"><%=srm.getDepartment() %></td>
							<td class="border border-info"><%=srm.getType() %></td>
							<td class="border border-info"><%=srm.getTime() %></td>
							<td class="border border-info"><%=srm.getMsg() %></td>
							<% 
                     		String stat= srm.getStatus();
                     		int s = Integer.parseInt(stat); 
                     		if(s == 3){ 
                     		%>
                     		<td class="border border-info"><button class="btn btn-primary">Approved</button></td>
                     		<%} else if(s == 2) { %>
                     		<td class="border border-info"><button class="btn btn-primary">HOD_Approved</button></td>
                     		<%} else if(s == 1){ %>
                     		<td class="border border-info"><button class="btn btn-primary">Apply</button></td>
                     		<%} else { %>
                     		<td class="border border-info"><button class="btn btn-primary">NotApproved</button></td>
                     		<% } %>
                     		</tr>
						<%} %>					  
						</tbody>
      ...
      <div class="title text-center mb-lg-5 mb-md-4 mb-sm-4 mb-3">
               <button type="submit" class="btn btn-warning"><a href="staff_dash.jsp">Back</a></button>
            </div>
