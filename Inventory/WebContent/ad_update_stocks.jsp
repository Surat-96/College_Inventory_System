   ...
   <div class="page-container">
		<!--start content-inner-->
			...
			<div class="mother-grid-inner">
				...
				<ol class="breadcrumb">
					<li class="breadcrumb-item"><a href="ad_index.jsp">Home</a> <i class="fa fa-angle-right"></i>Update Stocks</li>
				</ol>
				...
				<div class="grid-form1">
					...
					<div class="tab-content">
						<div class="tab-pane active" id="horizontal-form">
							<form action="stkupdt"class="form-horizontal" name="stock" method="post">
								<%
								...
								<div class="form-group">
									...
									<div class="col-sm-8">
										<input type="text" class="form-control1" name="itemname" id="itemname"value="<%=smod.getItemname()%>">
									</div>
								</div>
								<div class="form-group">
									<label for="focusedinput" class="col-sm-2 control-label">Item Type</label>
									<div class="col-sm-8">
										<input type="text" class="form-control1" name="type" id="type" value="<%=smod.getType()%>">
									</div>
								</div>
								<div class="form-group">
									<label for="focusedinput" class="col-sm-2 control-label">Item Details</label>
									<div class="col-sm-8">
										<input type="text" class="form-control1" name="details" id="details" maxlength="500" value="<%=smod.getDetails()%>">
									</div>
								</div>
								<div class="form-group">
									<label for="focusedinput" class="col-sm-2 control-label">Item Purchase Date</label>
									<div class="col-sm-8">
										<input type="date" class="form-control1" name="pdate" id="pdate" value="<%=smod.getPurchasedate() %>">
									</div>
								</div>
								<div class="form-group">
									<label for="focusedinput" class="col-sm-2 control-label">Item Warrenty Date</label>
									<div class="col-sm-8">
										<input type="date" class="form-control1" name="warrenty" id="warrenty" value="<%=smod.getWarrenty() %>">
									</div>
								</div>
								<div class="form-group">
									<label for="focusedinput" class="col-sm-2 control-label">Item cost</label>
									<div class="col-sm-8">
										<input type="text" class="form-control1" name="cost" id="cost" value="<%=smod.getCost() %>">
									</div>
								</div>
								<div class="form-group">
									<label for="focusedinput" class="col-sm-2 control-label">Quantity</label>
									<div class="col-sm-8">
										<input type="text" class="form-control1" name="quant" id="nquant" value="<%=smod.getQuantity() %>">
									</div>
								</div>
								...
								<div class="form-group">
									...
									<div class="col-sm-8">
										<img src="images/<%=smod.getImage() %>" width="200" height="200"><!--<a href="ad_change_image.jsp">Change Image</a>-->
									</div>
								</div>
								<%}%>
								<div class="row">
									<div class="col-sm-8 col-sm-offset-2">
										...
										<!--<button type="button" class="btn btn-primary">Delete</a>-->
									</div>
								</div>
							</form>
						</div>
