...
<html lang="zxx">
 ...
 <!-- short -->
	  ...
	  list=(ArrayList<staffmodel>)ses.getAttribute("info0");
	  %>
				...
				<% if(request.getAttribute("Message") != null) { %>
					...
					<div id="horizontalTab" style="display: block; width: 100%; margin: 0px;">
						<ul class="resp-tabs-list">
							<li class="resp-tab-item" aria-controls="tab_item-0" role="tab"><span>STAFF_DASHBOARD</span></li> 
						</ul>	
					<div class="clear"> </div>
					...
					<div class="tab-1 resp-tab-content1" aria-labelledby="tab_item-1">
							...
							<%
								...
								<%} %> 	
									...
									<a href="staff_update.jsp"><input type="submit" value="UPDATE" id = "update"></a>
							</div>
						</div>
					</div>							
				</div>	 
