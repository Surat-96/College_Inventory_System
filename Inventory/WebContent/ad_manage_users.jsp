   ...
   <div class="page-container">
		<!--start content-inner-->
			...
			<div class="mother-grid-inner">
					...
					<ol class="breadcrumb">
					<li class="breadcrumb-item"><a href="ad_index.jsp">Home</a> <i class="fa fa-angle-right"></i>Manage Users</li>
					</ol>
						...
						<div class="w3l-table-info">
							...
							<table id="table" class="table-bordered border-success">
								...
								<tbody>
									...
									<tr>
									<td><%=smod.getId() %></td>
									<td><%=smod.getStaffname() %></td>
									<td><%=smod.getEmailid() %></td>
									<td><%=smod.getAddress() %></td>
									<td><%=smod.getJoiningDate() %></td>
									<td><%=smod.getMobileno() %></td>
									<td><%=smod.getDepartment() %></td>
									<td><%=smod.getDesignation() %></td>
									<td>
									<form action="delstaf?id=<%=smod.getId()%>" method="post"><button type="submit" class="btn btn-primary btn-block">Delete</button></form>
									</td>
									</tr>
									<%} %>					  
								</tbody>
