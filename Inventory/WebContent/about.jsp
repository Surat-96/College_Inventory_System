...
<!-- short -->
      ...
      <!--about-->
      <!--about-one-->
      <section class="about-inner py-lg-4 py-md-3 py-sm-3 py-3" id="panel">
         <div class="container-fluid py-lg-5 py-md-4 py-sm-4 py-3" >
            ...
            <div class="row">
               ...
               <div class="col-lg-6 col-md-6 w3layouts-right-side-img">
                  ...
                  <div class="w3layouts-left-side-img">
                     <img src="images/i2.jpg" alt="g3 " class="img-fluid">
                  </div>
               </div>
            </div>
         </div>
            ...
            <div class="row">
               <div class="col-lg-3 col-md-6 col-sm-6 team-list-team">
                  <div class="team-member">
                     ...
                     <div class="team-hover">
                        <div class="desk">
                           <h4 class="mb-2">MANISH MAHATO</h4>
                           <p>PROJECT MEMBER</p>
                        </div>
                        <div class="s-link">
                           <ul>
                              <li><a href="https://www.facebook.com/manish.mahato.92775?epa=SEARCH_BOX"><span class="fab fa-facebook-f"></span></a></li>
                              <li><a href="manishmahato49@gmail.com"><span class="fas fa-envelope"></span></a></li>
                           </ul>
                        </div>
                     </div>
                  </div>
               ...
               <div class="col-lg-3 col-md-6 col-sm-6 team-list-team">
                  <div class="team-member">
                     ...
                     <div class="team-hover">
                        <div class="desk">
                           <h4 class="mb-2">LABANI BANERJEE</h4>
                           <p>PROJECT MEMBER</p>
                        </div>
                        <div class="s-link">
                           <ul>
                              <li><a href="https://www.facebook.com/mistu.banerjee.758?epa=SEARCH_BOX"><span class="fab fa-facebook-f"></span></a></li>
                              <li><a href="labanicrj@gmail.com"><span class="fas fa-envelope"></span></a></li>
                           </ul>
                        </div>
                     </div>
                  </div>
               ...
               <div class="col-lg-3 col-md-6 col-sm-6 team-list-team">
                  <div class="team-member">
                     ...
                     <div class="team-hover">
                        <div class="desk">
                           <h4 class="mb-2">SUMAN CHANDA</h4>
                           <p>PROJECT MEMBER</p>
                        </div>
                        <div class="s-link">
                           <ul>
                              <li><a href="https://www.facebook.com/suman.chanda.587"><span class="fab fa-facebook-f"></span></a></li>
                              <li><a href="sumanchanda2015@gmail.com"><span class="fas fa-envelope"></span></a></li>
                           </ul>
                        </div>
                     </div>
                  </div>
               ...
               <div class="col-lg-3 col-md-6 col-sm-6 team-list-team">
                  <div class="team-member">
                     ...
                     <div class="team-hover">
                        <div class="desk">
                           <h4 class="mb-2">SURAT BANERJEE</h4>
                           <p>PROJECT LEADER</p>
                        </div>
                        <div class="s-link">
                           <ul>
                              <li><a href="https://www.facebook.com/goku.tarus"><span class="fab fa-facebook-f"></span></a></li>
                              <li><a href="banerjeesurat@gmail.com"><span class="fas fa-envelope"></span></a></li>
                           </ul>
                        </div>
                     </div>
                  </div>
