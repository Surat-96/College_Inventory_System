      ...
      <section class="contact py-lg-4 py-md-3 py-sm-3 py-3">
         <div class="container py-lg-5 py-md-4 py-sm-4 py-3">
            ...
            <div class="agile-info-para">
               ...
               <form action="enqadd" method="post"> 
                  <div class="row agile-wls-contact-mid">
                     <div class="col-md-4 form-group contact-forms">
                        <input type="text" name="name" id="name" class="form-control" placeholder="name" value="<%=smod.getStaffname() %>">
                     </div>
                     <div class="col-md-4 form-group contact-forms">
                        <input type="email" name="email" id="email" class="form-control" placeholder="email" value="<%=smod.getEmailid() %>">
                     </div>
                     <div class="col-md-4 form-group contact-forms">
                        <input type="text" name="dept" id="dept" class="form-control" placeholder="dept" value="<%=smod.getDepartment() %>">
                     </div>
                     <div class="col-md-6 form-group contact-forms">
                        <input type="text" name="desi" id="desi" class="form-control" placeholder="desi" value="<%=smod.getDesignation() %>">
                     </div>
                     <div class="col-md-6 form-group contact-forms">
                        <input type="datetime-local" name="time" id="time" class="form-control" placeholder="posting-date" required="">
                     </div>
                  </div>
                  <div class="form-group contact-forms">
                     <textarea class="form-control" name="msg" id="msg" rows="3" placeholder="Message.." required=""></textarea>
                  </div>
