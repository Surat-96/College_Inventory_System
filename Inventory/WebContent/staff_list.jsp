...
<html lang="zxx">
 ...
 <!-- short -->
      ...
      <% list=(ArrayList<staffmodel>)request.getAttribute("info");%>
                        ...
                        <table class="table" id="table">
                           ...
                           <%
            				for(staffmodel smod : list)
            				{
          					 %>
                               <tr>
								<td class="border border-info"><%= smod.getStaffname() %></td>
								<td class="border border-info"><%= smod.getEmailid() %></td>
								<td class="border border-info"><%= smod.getAddress() %></td>
								<td class="border border-info"><%= smod.getJoiningDate() %></td>
								<td class="border border-info"><%= smod.getMobileno() %></td>
								<td class="border border-info"><%= smod.getDepartment() %></td>
								<td class="border border-info"><%= smod.getDesignation() %></td>
								</tr>
							<%} %>
							</tbody>
						</table>
