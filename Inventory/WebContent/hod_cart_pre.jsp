...
<html lang="zxx">
 ...
 <!-- short -->
	  ...
	  <div class="title text-center mb-lg-5 mb-md-4 mb-sm-4 mb-3">
               <h3>Show-MyCart-List</h3>
            </div>
       <div class="agile-info-para">
               <!--contact-map -->
               <% for(staffmodel smod : list) { %> 
               <form action = "hodproli" method = "post"> 
                  <div class="row agile-wls-contact-mid">
                     ...
                     <div class="col-md-4 form-group contact-forms">
                        <input type="text" name="dept" id="dept" class="form-control" value="<%=smod.getDepartment() %>">
                     </div>
                     <div class="col-md-4 form-group contact-forms">
               ...
               <%} %>
                  ...
                  <% for(staffmodel smod : list) { %>
                <form action = "hodserli" method = "post"> 
                  <div class="row agile-wls-contact-mid">  
                     <div class="col-md-4 form-group contact-forms">
                     ...
                     <div class="col-md-4 form-group contact-forms">
                        <button type="submit" class="btn btn-success">Check-Service</button>
                     </div>
                  </div>
               </form>
               <%} %>
