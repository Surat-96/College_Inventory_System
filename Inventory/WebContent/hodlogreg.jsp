				...
				<% if(request.getAttribute("Message") != null) { %>
					...
					<div id="horizontalTab" style="display: block; width: 100%; margin: 0px;">
						<ul class="resp-tabs-list">
							<li class="resp-tab-item" aria-controls="tab_item-0" role="tab"><span>HOD Sign in</span></li> 
							<li class="resp-tab-item" aria-controls="tab_item-1" role="tab"><label>/</label><span>HOD Sign up</span></li>
						</ul>	
					<div class="clear"> </div>
						...
						<div class="tab-1 resp-tab-content" aria-labelledby="tab_item-1">
							<div class="login-agileits-top sign-up"> 
								<form action="staffregistration" method="post">
									<p>HOD Name </p>
									<input type="text" name="staffname" id="staffname1" maxlength="20" required="" autofocus="" />
									<!--  <p id="validationMessage" style="color: red; font-weight: bold;"></p>-->
									<p>Email-ID </p>
									<input type="email" name = "email" id="email" required="" autofocus="" autocomplete="off" onblur="ajaxFunction()"/>
									<p>Password</p>
